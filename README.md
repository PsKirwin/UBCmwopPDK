# UBCmwopPDK (SiEPIC Ebeam PDK) 3.3.4
...
[![pypi](https://img.shields.io/pypi/v/UBCmwopPDK)](https://pypi.org/project/UBCmwopPDK/)
...
```
uv pip install UBCmwopPDK --upgrade
```
...
- [UBCmwopPDK docs](https://gdsfactory.github.io/ubc/) and [code](https://github.com/gdsfactory/ubc)
